...
import static br.mr.dias.core.DriverFactory.getDriver;
...
public class DSL {
	...
	public void clicarRadioORCheck(By by)
	{
		getDriver().findElement(by).click();
	}
	
	public void clicarRadioORCheck(String id)
	{
		clicarRadioORCheck(By.id(id));
	}
	
	public boolean isRadioORCheckMarcado(String id)
	{
